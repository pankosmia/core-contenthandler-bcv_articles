...
> **Note:** This package does not contain everything available inside `pankosmia/core-contenthandler-bcv_articles`. It only exposes reusable components that may or may not be used by other Pankosmia clients.
...
- The complete `pankosmia/core-contenthandler-bcv_articles` application
